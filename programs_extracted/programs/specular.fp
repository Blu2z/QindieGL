...
outdata main(float2 TEX0   : TEXCOORD0, //DIFFUSE
			 ...
			 float3 TEX3   : TEXCOORD3, //half - angle
			 float4 COLOR  : COLOR0,
			 uniform sampler2D	 diffuse:TEXUNIT0,
	     ...
	     )
{
   outdata OUT;
    ...
    float3 normal=tex2D(normalmap,TEX3).xyz;
...
//   OUT.color=tex2D(diffuse,TEX0)*diffuse_int*COLOR+spec_int16*0.5*COLOR;
   ...
   OUT.color=tex2D(diffuse,TEX0)*spec_int16;//0.5*COLOR;
