...
// Textures combine: (fresnel blend diffuse)*Lightmap
// value for blendig is a alpha of diffuse texture
/////////////////////////////////////////////////
	     ...
	     )
{
   outdata OUT;
    ...
    float4 diffuseColor=tex2D(diffuse,TEX0); 
    float3 blendedColor=( reflectRefract * ( 1.0 - diffuseColor.a ) ) + ( diffuseColor.rgb * diffuseColor.a);
    

    
	float4 res_color;
    res_color.rgb	= blendedColor*tex2D(lightmap,TEX3)*2.0;
    res_color.a		= COL.x; //alpha - fresnel intensivity
